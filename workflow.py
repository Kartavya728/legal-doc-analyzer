from workflow_functions import property_workflow, regulatory_workflow, personal_workflow, litigation_workflow, corp_workflow, contarct_workflow, govt_workflow
...
if (level1_category == "Property & Real Estate"):
    ...
    document_summary,json_f = litigation_workflow(chunks, level1_category)
   ...
   document_summary,json_f = contarct_workflow(chunks)
